...
/// Encode a BitString into a base 64 encoded string.
...
/// Decode a base 64 encoded string into a BitString.
...
/// Encode a BitString into a base 64 encoded string with URL and filename safe alphabet.
...
/// Decode a base 64 encoded string with URL and filename safe alphabet into a BitString.
